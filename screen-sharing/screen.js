...
(function() {
    ...
    window.Screen = function(channel) {
        ...
        if (getParameterByName("id").length > 0) {
            ...
            this.channel = getParameterByName("id");
            channel = getParameterByName("id");
        }else{
    ...
    function Signaler(root, roomid) {
        ...
        this.broadcast = function(_config) {
            ...
            console.log("_config.roomid"+_config.roomid);
            console.log("signaler.roomid"+signaler.roomid);
        ...
        if (!root.openSignalingChannel) {
            ...
            console.log("root.channel: "+root.channel);
...
function getParameterByName(name) {
    ...
    //var r="httplocalhostfirefoxscreen-sharingindexhtml"+decodeURIComponent(results[1].replace(/\+/g, " "));
    if(results === null)
        return "" 
    else
        return "httplocalhostfirefoxscreen-sharingindexhtml"+decodeURIComponent(results[1].replace(/\+/g, " "));
}
