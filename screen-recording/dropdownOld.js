...
$('#full-screen').click(function(){
    console.log("sdfsd hola mundo");
}); 
document.getElementById('full-screen').onclick = function() {    

console.log("sdfsd hola full-screen");

    optionsMain.enableTabCaptureAPI = false;
    optionsMain.enableMicrophone = false;
    optionsMain.enableCamera = false;
    optionsMain.enableScreen = true;
    optionsMain.isRecording = true;
    optionsMain.enableSpeakers = false;
