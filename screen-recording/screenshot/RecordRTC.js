    ...
    var returnObject = {
        ...
        onStateChanged: function(state) {
            if (!config.disableLogs) { 
                ...
                /*if(state.localeCompare("stopped")==0) {
                    console.log("ingresando para tomar foto");
                    captureImage();
                }*/
            }
        },
...
function MediaStreamRecorder(mediaStream, config) {
    ...
    /**
     * This method returns array of blobs. Use only with "timeSlice". Its useful to preview recording anytime, 
     * without using the "stop" method.
     * @method
